            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4 pt-2 flex flex-col items-center">
                ...
                <button
                  ...
                  className="w-auto px-6 py-2.5 rounded-full bg-[#f4f4f4] hover:bg-[#eaeaea] text-slate-700 font-bold text-[11px] flex items-center justify-center gap-2 transition-all duration-200 border border-slate-100 hover:scale-[1.01] active:scale-[0.99] mx-auto"
                >
