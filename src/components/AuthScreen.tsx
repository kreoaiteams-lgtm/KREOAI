...
const VisualIllustration = () => {
  return (
    <div className="relative w-full h-[360px] md:h-full min-h-[380px] md:min-h-0 bg-[#eef1f6] rounded-[2.5rem] overflow-hidden flex items-center justify-center select-none shadow-[0_15px_35px_rgba(0,0,0,0.05)] border border-slate-100/50">
      <img 
        src="/ChatGPT Image May 18, 2026, 04_26_23 PM.png" 
        alt="Kreo 3D Illustration" 
  ...
  return (
    <>
      ...
      <div className="min-h-screen w-full flex flex-col items-center justify-center overflow-x-hidden bg-[#e5e5e5] py-12 px-4 md:px-6 relative">
        ...
        >
          {/* Left Column: Cozy custom ChatGPT generated 3D illustration image */}
          <VisualIllustration />
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-3 pt-2">
                ...
                <button
                  ...
                  className="w-full rounded-full bg-[#f4f4f4] hover:bg-[#eaeaea] text-slate-700 font-bold text-[10px] py-2 flex items-center justify-center gap-2 transition-all duration-200 border border-slate-100 active:scale-[0.99]"
                >
                  <svg className="h-3.5 w-3.5 fill-current text-slate-800" aria-hidden="true" viewBox="0 0 24 24">
