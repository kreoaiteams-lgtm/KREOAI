      ...
      <div className="min-h-screen w-full flex flex-col items-center justify-center overflow-x-hidden bg-gradient-to-br from-[#d9e4f6] via-[#f0f4fa] to-[#cfdff4] py-12 px-4 md:px-6 relative">
        ...
        >
          ...
          <div className="relative w-full h-[360px] md:h-full min-h-[380px] md:min-h-0 bg-[#eef1f6] rounded-[2.5rem] overflow-hidden flex items-center justify-start select-none shadow-inner border border-slate-100">
            ...
            <div className="absolute top-[28%] left-1/2 -translate-x-1/2 z-20 text-center w-full">
              <h1 
                className="text-[5rem] md:text-[6.5rem] text-slate-900 tracking-tighter font-black uppercase select-none drop-shadow-xl"
                style={{ fontFamily: "'TAN-NIMBUS', sans-serif", lineHeight: 0.9 }}
              >
                KREO
              </h1>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-4 pt-4 flex flex-col items-center">
                ...
                <button
                  ...
                  className="w-full px-6 py-3.5 rounded-2xl bg-[#f4f4f4] hover:bg-[#eaeaea] text-slate-700 font-bold text-xs flex items-center justify-center gap-2.5 transition-all duration-200 border border-slate-200 hover:border-slate-300 hover:scale-[1.01] active:scale-[0.99]"
                >
